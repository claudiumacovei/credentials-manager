...
public class ServiceProvider implements Serializable {
    ...
    public void setCredentials(Set<Credential> credentials) {
        if (this.credentials != null) {
            this.credentials.forEach(i -> i.removeServiceProviders(this));
        }
        if (credentials != null) {
            credentials.forEach(i -> i.addServiceProviders(this));
        }
    ...
    public ServiceProvider addCredentials(Credential credential) {
        this.credentials.add(credential);
        credential.getServiceProviders().add(this);
        return this;
    }

    public ServiceProvider removeCredentials(Credential credential) {

...
public class Credential implements Serializable {
    ...
    @ManyToMany
    @JoinTable(
        name = "rel_credential__service_providers",
        joinColumns = @JoinColumn(name = "credential_id"),
        inverseJoinColumns = @JoinColumn(name = "service_providers_id")
    )
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public Credential addServiceProviders(ServiceProvider serviceProvider) {
        this.serviceProviders.add(serviceProvider);
        serviceProvider.getCredentials().add(this);
        return this;
    }

    public Credential removeServiceProviders(ServiceProvider serviceProvider) {

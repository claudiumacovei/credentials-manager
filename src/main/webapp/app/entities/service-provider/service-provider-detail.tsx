    ...
    <Row>
      <Col md="8">
        <h2 data-cy="serviceProviderDetailsHeading">
          <Translate contentKey="credentialsmanagerApp.serviceProvider.detail.title">ServiceProvider</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="credentialsmanagerApp.serviceProvider.name">Name</Translate>
            </span>
          </dt>
          ...
          <dd>{serviceProviderEntity.credential ? serviceProviderEntity.credential.id : ''}</dd>
        </dl>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="credentialsmanagerApp.credential.home.createOrEditLabel" data-cy="CredentialCreateUpdateHeading">
            <Translate contentKey="credentialsmanagerApp.credential.home.createOrEditLabel">Create or edit a Credential</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('credentialsmanagerApp.credential.profile')}
              ...
              />
              <ValidatedField
                label={translate('credentialsmanagerApp.credential.enabled')}
              ...
              />
              <ValidatedField
                label={translate('credentialsmanagerApp.credential.username')}
              ...
              />
              <ValidatedField
                label={translate('credentialsmanagerApp.credential.password')}
              ...
              <ValidatedField
                ...
                label={translate('credentialsmanagerApp.credential.identityProvider')}
                type="select"
              >
                <option value="" key="0" />
                {identityProviders
              ...
              <ValidatedField
                label={translate('credentialsmanagerApp.credential.serviceProviders')}
                id="credential-serviceProviders"

...
export const CredentialDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="credentialsmanagerApp.credential.delete.question">
        <Translate contentKey="credentialsmanagerApp.credential.delete.question" interpolate={{ id: credentialEntity.id }}>

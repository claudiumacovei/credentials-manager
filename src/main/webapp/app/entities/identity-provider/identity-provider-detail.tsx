    ...
    <Row>
      <Col md="8">
        <h2 data-cy="identityProviderDetailsHeading">
          <Translate contentKey="credentialsmanagerApp.identityProvider.detail.title">IdentityProvider</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="name">
              <Translate contentKey="credentialsmanagerApp.identityProvider.name">Name</Translate>
            </span>
          </dt>

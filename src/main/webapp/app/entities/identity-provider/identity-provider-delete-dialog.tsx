...
export const IdentityProviderDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="credentialsmanagerApp.identityProvider.delete.question">
        <Translate contentKey="credentialsmanagerApp.identityProvider.delete.question" interpolate={{ id: identityProviderEntity.id }}>
